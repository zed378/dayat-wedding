  ...
  return (
    <div className="bg-black w-full h-screen opening flex flex-col justify-center items-center gap-2 relative overflow-hidden">
      ...
      <Fade direction="down" cascade>
        ...
        <h2 className="pacifico text-pink-500 text-6xl text-center px-2">
          Fatchur dan Arika
        </h2>
      </Fade>

      <Fade direction="up" cascade>
        <h1 className="text-xl text-pink-500 text-center mt-9 px-2 ">
          Kepada Yth. Bapak/Ibu/Saudara/i:
        </h1>
        <div className="capitalize satisfy text-pink-500 text-3xl text-center px-2 ">
